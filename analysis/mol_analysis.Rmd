...
air_samples <- matrix(
  c("B", "25-01-2023", "HRV", "Air",
    ...
    "B", "01-02-2023", "Flu B", "Filter", # we use the middle of the week(s) when the swabs were taken
    "A", "05-03-2023", "CoV", "Filter",
    "A", "05-03-2023", "AdV", "Filter",
    "A", "05-03-2023", "HRV", "Filter"),
  ncol = 4, byrow = T
) %>%
  data.frame() %>%
...
tnet_pl <- tnet %>%
  ...
  labs(size = "Number of infections", fill = "Virus", shape = "") +
...
save_plot(tnet_pl, pdf_file = "../results/mol-data/network-plot.pdf", eps_file = "../results/mol-data/network-plot.eps", w = 16, h = 21)
```
