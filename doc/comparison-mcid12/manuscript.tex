...
\title{\bfseries\LARGE\singlespacing{Molecular detection of SARS-CoV-2 and other respiratory viruses in saliva, air, and filter samples from schools during and after the pandemic}}
...
\begin{information}\normalfont
\textbf{Word count:} Abstract 248 (max 250), Manuscript 1,187 (max 1,200) \\
\textbf{Display items:} Figure 1 (max 2) \\
\textbf{References:} 14 (max 15) \\
