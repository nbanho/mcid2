...
\begin{figure}[!htpb]
    ...
    \caption{\textbf{Analysis of molecular data}. \textbf{(a,b)}~No. of positive saliva samples by virus and study condition. \textbf{(c)}~Daily no. of infections (1 to 3 as dot sizes) and possible transmission chains (arrows). Flu B: Influenza B, HRV: rhinovirus, AdV: adenovirus, CoV: SARS-CoV-2, MPV: metapneumovirus, PIV: parainfluenza virus.}
