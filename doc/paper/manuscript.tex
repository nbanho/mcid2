...
\begin{figure}[!htpb]
    ...
    \caption{\textbf{Analysis of molecular data}. \textbf{(a)}~Number of positive saliva samples by virus. \textbf{(b)}~Number of positive saliva samples by study condition. \textbf{(c)}~Possible transmission chains within classes. Direction of transmission as arrows. Number of infections per day as dot sizes. Viruses: Influenza B (Flu B), rhinovirus (HRV), adenovirus (AdV), SARS-CoV-2 (CoV), metapneumovirus (MPV), parainfluenza virus (PIV).}
