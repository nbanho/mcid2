...
Differences in the frequency of coughs between classes suggest an association with class-specific virus patterns. \Cref{fig:coughing-association} shows the relative risk of cough for each respiratory virus. Cough appeared more frequent for Flu~B and less frequent for AdV.  
